...
if (isset($_POST['submit'])) {    //to check if submit button is clicked or not
    ...
    $stmt = mysqli_prepare($conn,'INSERT INTO stock(category,item,product_name,description,cost,image) VALUES ( ?,?,?,?,?,?)');
            mysqli_stmt_bind_param($stmt, 'ssssis',$_POST['category'], $_POST['item'],$_POST['product_name'],$_POST['description'],$_POST['cost'],$img_des);
