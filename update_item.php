...
if (isset($_POST['update'])) {
    ...
    $stmt = mysqli_prepare($conn, "UPDATE stock SET category = ?, item = ?, product_name = ?, description = ?, cost = ?, image = ? WHERE item_id = ?");
    mysqli_stmt_bind_param($stmt, 'ssssisi', $_POST['category'], $_POST['item'], $_POST['product_name'], $_POST['description'], $_POST['cost'], $img_des, $_POST['item_id']);
    mysqli_stmt_execute($stmt);
